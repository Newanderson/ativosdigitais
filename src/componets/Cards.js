...
const Cards = () => {
    return(
        <div className=" w-full bg-[#273A73] px-4 my-28 cursor-pointer ">
            ...
            className='flex justify-center center m-10 text-center text-3xl font-bold text-[#36D97D]    '>Acelere seus resultados</motion.div>
         ...
         >
            <img className='w-[120px]  mt-15 bg-[] mx-auto' src={ecomerce} alt="/" />
            ...
            className="w-full flex flex-col border rounded-lg p-8  cursor-pointer">
            <img className='w-[120px]  mt-15 bg-[#273A73] mx-auto' src={treinamento} alt="/" />
         ...
         bg-[#36d97d] w-[200px] rounded-md font-medium  my-[90px] p-3  mx-auto  text-[#273A73] text-center transition duration-300 hover:skew-y-2 hover:text-[#36d97d] 
