...
const Home = () => {
    return(
        <div className="text-[#E6E6EA] ">
            ...
            className="text-[#36d97d] font-bold p-15 text-xl">marketing growth</motion.p>
            ...
            className="md:text-5xl sm:text-2xl text-2xl font bold ">Potencialize suas Vendas</motion.h1>
